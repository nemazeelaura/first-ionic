...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/laura/Desktop/first-ionic/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/laura/Desktop/first-ionic/src/pages/tabs/tabs.html"*/
        }),
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"/Users/laura/Desktop/first-ionic/src/pages/about/about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/Users/laura/Desktop/first-ionic/src/pages/about/about.html"*/
        }),
...
var ContactPage = (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"/Users/laura/Desktop/first-ionic/src/pages/contact/contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      @ionicframework\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/laura/Desktop/first-ionic/src/pages/contact/contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
var HomePage = (function () {
    ...
    HomePage.prototype.findCharacter = function (name) {
        var _this = this;
        console.log("finding " + name);
        this.http.get('https://swapi.co/api/people/?search=' + name)
            .toPromise()
            .then(function (response) { return _this.results = response.json().results; });
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/laura/Desktop/first-ionic/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <section>\n  <h2>search for a character</h2>\n  Search String: {{name}}\n    <input [(ngModel)]="name" type="text" placeholder="character name"/>\n    <input type="submit" (click)="findCharacter(name)" value="search"/>\n</section>\n\n<section *ngIf="results">\n    <h2>Search Results</h2>\n    <ul>\n        <li *ngFor="let character of results">\n            <h3>{{character.name}}</h3>\n            <dl>\n                <dt>Birth Year</dt>\n                <dd>{{character.birth_year}}</dd>\n                <dt>Eye Color</dt>\n                <dd>{{character.eye_color}}</dd>\n                <dt>Hair Color</dt>\n                <dd>{{character.hair_color}}</dd>\n                <dt>Gender</dt>\n                <dd>{{character.gender}}</dd>\n                <dt>Height</dt>\n                <dd>{{character.height}}</dd>\n                <dt>Mass</dt>\n                <dd>{{character.mass}}</dd>\n                <dt>Skin Color</dt>\n                <dd>{{character.skin_color}}</dd>\n            </dl>\n        </li>\n    </ul>\n</section>\n</ion-content>\n\n'/*ion-inline-end:"/Users/laura/Desktop/first-ionic/src/pages/home/home.html"*/
        }),
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/laura/Desktop/first-ionic/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/laura/Desktop/first-ionic/src/app/app.html"*/
        }),
